...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
    ...
    private int textZoomInSize;
    private boolean isTextTitleSizeCoarsening;
    ...
    public void setTextTitleSizeCoarsening(boolean textTitleSizeCoarsening) {
    ...
    public void setTextZoomInSize(int textZoomInSize) {
        this.textZoomInSize = textZoomInSize;
    }
        ...
        if (currentSelectedTabPosition > -1 && tabsLayout != null
            ...
            if (currentSelectedTabView != null) {
                ...
                if (textSizeTag) {
                    ...
                    setTextViewSize(textSize);
                }
                //默认字体不变粗
                if (isTextTitleSizeCoarsening) {
                    setTextCoarsening(false);
                }
            }
            ...
            if (currentSelectedTabView != null) {
                ...
                if (textSizeTag) {
                    ...
                    setTextViewSize(textZoomInSize);
                }
                //选中字体变粗
                if (isTextTitleSizeCoarsening) {
                    setTextCoarsening(true);
                }
            }
            Logger.e("PagerSlidingTabStrip", "选中指定位置的TAB方法执行了");
        }
    }

    private void setTextCoarsening(boolean isTextCoarsening) {
        if (currentSelectedTabView instanceof TextView) {
            TextView textView = (TextView) currentSelectedTabView;
            TextPaint tp = textView.getPaint();
            tp.setFakeBoldText(isTextCoarsening);
        }
    }
